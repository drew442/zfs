...
static size_t
zfs_qat_deflate_compress_buf(void *s_start, void *d_start, size_t s_len,
    size_t d_len, int n)
{
	int ret;
	zlen_t dstlen = d_len;
...
static int
zfs_qat_deflate_decompress_buf(void *s_start, void *d_start, size_t s_len,
    size_t d_len, int n)
{
	(void) n;
	zlen_t dstlen = d_len;
...
ZFS_COMPRESS_WRAP_DECL(zfs_qat_deflate_compress)
ZFS_DECOMPRESS_WRAP_DECL(zfs_qat_deflate_decompress)
